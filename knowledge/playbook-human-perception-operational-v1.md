...
**Мир:** `cognition.human-perception` — см. [`worlds/cognition-human-perception/README.md`](worlds/cognition-human-perception/README.md).  
...
**Order:** сначала этот playbook; при узком UI‑вопросе — [`playbook-hci-core-v1.md`](playbook-hci-core-v1.md); классика эвристик — [`kb-ui-ux-literature-evidence-v1.md`](kb-ui-ux-literature-evidence-v1.md).
...
- **Не заменяет:** клиническую психологию, терапию, медицинские протоколы — при необходимости см. домен Psychology и `kb-therapy-and-support-boundaries-v1.md`.
...
4. Для агента: **гранулярность** ответа соответствует намерению; не «простыня» при запросе на один шаг (см. `playbook-hci-core-v1.md` § Dialogue).
...
| Общие контракты HCI, доступность, диалог | `playbook-hci-core-v1.md`, `kb-hci-usability-and-dialog-rules-v1.md` |
| Эвристики Norman/Nielsen/… | `kb-ui-ux-literature-evidence-v1.md` |
| DX инструмента, трение | `de-dx-playbook.md`, `kb-ide-dx-literature-evidence-v1.md` |
| Метафора кокпита / PFD/MFD в IDE | `kb-aviation-pfd-mfd-efis-eicas-fundamentals-v1.md` (авиация как язык), **конкретные** нормы — ADR репозитория CascadeIDE |
...
- Не использовать этот playbook как **оправдание** манипуляции вниманием во вред; baseline целостности — `playbook-integrity-under-pressure-v1.md`.
