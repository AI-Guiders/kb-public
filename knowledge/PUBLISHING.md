...
**Group KB (`AI-Guiders/kb`, MCP `group`):** **SSOT общего знания** (ADR [011](adr/011-aiguiders-org-collaborative-kb-repo-v1.md) Accepted). Пары пишут PR / `export-to-org-kb.ps1`; routine **не** full replace (`bootstrap-org-kb.ps1` / `seed-org-kb.ps1 -Push` — только bootstrap/DR). **`seed-org-kb.ps1`** собирает `dist/group-kb/` (public slice + выборочный `work/projects/` по **`group-kb.ignore`**). Scope contour: [`work/org/scope-contour-map-v1.md`](work/org/scope-contour-map-v1.md). Runbook: [`work/projects/door-to-singularity/agent-notes-kb/templates/runbook-org-kb-federation-v1.md`](work/projects/door-to-singularity/agent-notes-kb/templates/runbook-org-kb-federation-v1.md). Сводка контуров: [`domains/agent-operations/map-kb-three-contours-v1.md`](domains/agent-operations/map-kb-three-contours-v1.md).
