...
- source_refs:
  ...
  - cross_ref: продуктовые эвристики UI (Norman, Nielsen, …) — `../hci-ux-dx/kb-ui-ux-literature-evidence-v1.md`; HCI-операционка — `../hci-ux-dx/playbook-hci-core-v1.md`
...
Семантические имена: `kb-human-perception-<работа>-evidence-v1.md` — тот же слой, что прочие **`kb-*-evidence-v1`** (см. [`templates/template-knowledge-card-v1.md`](../../templates/template-knowledge-card-v1.md), [`META/provenance-contract-v1.md`](../../META/provenance-contract-v1.md)). Содержимое: **проверяемые тезисы**, методы, ограничения, UX-мост; дословные цитаты в KB не обязательны.
