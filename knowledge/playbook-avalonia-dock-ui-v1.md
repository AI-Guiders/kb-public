...
- Согласование с HCI: `playbook-hci-core-v1`, `ui-ux-playbook`
...
5. Повторяемый инцидент — карточка по `template-knowledge-card-v1.md` с путём к коду инициализации и именем grammar.

## Integration with other playbooks

- **C# диагностика / рефакторинг:** `dotnet-roslyn-debug-playbook.md`
- **Сборка/тест/отладка общая:** `tooling-debug-playbook.md`
- **DX-поток и среда (не только UI):** `de-dx-playbook.md`
- **Общий .NET frontend:** `frontend-dotnet-playbook.md`
- **HCI / продуктовый UX:** `playbook-hci-core-v1.md`, `ui-ux-playbook.md`, `kb-hci-usability-and-dialog-rules-v1.md`
