...
- source_refs: `kb-videography-cinematography-theory-v1.md` §13
...
- context: контент по миру media.video-surveillance (размещение, покрытие, retention, персональные данные) хранится в kb-videography-cinematography-theory-v1.md, §13 и правила R9–R12
- signal: запрос о CCTV, видеонаблюдении, охранных камерах, слепых зонах, retention видеозаписей, законности видеонаблюдения
- action: загружать `knowledge/kb-videography-cinematography-theory-v1.md`; применять правила и разделы с world media.video-surveillance
...
- source_refs: `kb-ml-applied-theory-v1.md`
- created_at: `2026-03-01`
- updated_at: `2026-03-01`
...
- action: загружать `knowledge/kb-ml-applied-theory-v1.md`; применять правила и разделы с world software.ml-applied
...
- source_refs: `playbook-music-v1.md`, `kb-music-theory-fundamentals-v1.md`, `kb-music-acoustics-v1.md`, `kb-music-temperaments-math-v1.md`, `kb-music-non-western-v1.md`
- created_at: `2026-03-01`
- updated_at: `2026-03-01`
...
- action: загружать `knowledge/playbook-music-v1.md` для маршрутизации; по теме запроса — соответствующий kb (fundamentals / acoustics / temperaments-math / non-western); применять правила и разделы с world arts.music
