...
| **Cascade IDE** | [Документация](https://ai-guiders.github.io/cascade-ide/) |
| **Организация** | [ai-guiders.github.io](https://ai-guiders.github.io/) |

## Лицензия

Тексты KB — **CC BY-SA 4.0** (`LICENSE`). Код MCP — **MIT** (отдельный репозиторий).
